...
describe('Type Guards', () => {
  ...
  describe('isSerializedProperty', () => {
    ...
    it('should reject invalid required field types', () => {
      expect(isSerializedProperty(createValidProperty({ id: 123 as any }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ price: 'abc' as any }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ title: null as any }))).toBe(false)
    })

    it('should reject invalid numeric fields', () => {
      expect(isSerializedProperty(createValidProperty({ price: -100 }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ price: NaN }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ price: Infinity }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ bathrooms: -1 }))).toBe(false)
      expect(isSerializedProperty(createValidProperty({ area: NaN }))).toBe(false)
    })
    ...
    it('should reject invalid Date fields', () => {
      expect(
        isSerializedProperty(createValidProperty({ createdAt: 'not-a-date' as any })),
      ).toBe(false)
      expect(
  ...
  describe('assertIsSerializedProperty', () => {
    ...
    it('should throw for invalid property', () => {
      ...
      expect(() => assertIsSerializedProperty(invalidProperty)).toThrow(TypeError)
    })
