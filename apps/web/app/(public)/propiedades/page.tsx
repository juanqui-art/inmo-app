...
export default async function PropiedadesPage(props: PropiedadesPageProps) {
  ...
  // Fetch properties (uses React.cache() for request-level deduplication)
  ...
  return (
    <>
      {/* Hydrate the property grid store with fetched data */}
      <PropertyGridStoreInitializer
        ...
        filters={filters}
      />
      {/* Render the property grid page (client component that reads from store) */}
      <PropertyGridPage />
    </>
  );
}
