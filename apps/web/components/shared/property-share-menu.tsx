...
interface ShareOption {
  ...
  color: string;
  action: (url: string, title: string, price?: number | string | { toString(): string }) => void;
}
  ...
  const shareOptions: ShareOption[] = [
    {
      ...
      color: "hover:bg-green-100 dark:hover:bg-green-900/30 text-green-600 dark:text-green-400",
      action: (url: string, title: string, price?: number | string | { toString(): string }) => {
    ...
    },
    {
      ...
      color: "hover:bg-black/10 dark:hover:bg-white/10 text-black dark:text-white",
      action: (url: string) => {
        navigator.clipboard.writeText(url);
    ...
    },
    {
      ...
      color: "hover:bg-orange-100 dark:hover:bg-orange-900/30 text-orange-600 dark:text-orange-400",
      action: (url: string, title: string, price?: number | string | { toString(): string }) => {
