        ...
        {!isLoadingCities && cities.length > 0 && (
          <div className="px-4 py-3 border-t border-oslo-gray-800">
            <button
              ...
              onClick={handleDone}
              disabled={isLoading}
              className="w-full px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold text-sm hover:bg-blue-500 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-oslo-gray-900 disabled:bg-oslo-gray-700 disabled:cursor-not-allowed"
            >
              Listo
            </button>
          </div>
